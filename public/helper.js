window.Toast = function (title, type, msg) {
  ...
  if (type == "info") color = "text-yellow-600";
  ...
  <span class="flex font-extrabold ${color} text-2xl capitalize">${title}
  ...
  <p class="font-semibold text-slate-300 text-lg normalize">${msg}</p>
</div>`;
